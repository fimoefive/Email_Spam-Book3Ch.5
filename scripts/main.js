...
// here's a function within a function
customers.forEach(customers => customers.contacts.email.forEach(email => emailArray.push(email)));

// iterate through each customer and find "email, then for each email push it into the "emailArray"
